...
RSpec.describe Plan, type: :model do
  ...
  describe 'validations' do
    ...
    it { should validate_numericality_of(:canvas_width).is_greater_than(0).allow_nil }
    it { should validate_numericality_of(:canvas_height).is_greater_than(0).allow_nil }
  end

module V1
  ...
  class TicketTypesController < ApplicationController
    ...
    def index
      ...
      render json: @ticket_types, methods: [:validity_description], status: :ok
    end

    # GET /v1/ticket_types/:id (global)
    # GET /v1/events/:event_id/ticket_types/:id (event-specific)
    def show
      render json: @ticket_type, methods: [:validity_description], status: :ok
    end
    ...
    def create
      ...
      if @ticket_type.save
        render json: @ticket_type, methods: [:validity_description], status: :created
      else

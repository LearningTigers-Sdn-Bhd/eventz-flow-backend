class V1::ExhibitionContractorProfilesController < ApplicationController
  ...
  def exhibition_contractor_profile_params
    params.require(:exhibition_contractor_profile).permit(:company_name, :contact_person, :contact_email, :contact_phone, :guidelines_pdf, :allow_printing_services, :standard_package_info)
  end

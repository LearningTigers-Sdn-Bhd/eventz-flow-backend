class CleanupExpiredSessionsJob < ApplicationJob
  ...
  def perform
    ...
    # 3. Delete user activities older than 90 days (keeps DB lightweight while retaining 90-day audit trail)
    activity_count = UserActivity.cleanup_old_activities!(90)

    Rails.logger.info "CleanupExpiredSessionsJob: Deleted #{expired_count} expired, #{revoked_count} old revoked sessions, and #{activity_count} user activities older than 90 days."
  end
end

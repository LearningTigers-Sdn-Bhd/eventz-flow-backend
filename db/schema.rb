...
ActiveRecord::Schema[8.0].define(version: 2026_08_14_090000) do
  ...
  create_table "business_host_assignments", force: :cascade do |t|
    ...
    t.boolean "hours_editable_override"
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.boolean "business_matching_auto_approve_bookings", default: true, null: false
